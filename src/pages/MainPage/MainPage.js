...
export default function MainPage() {
	...
	useEffect(() => {
		axios
			.get(
				videoId
					? `http://localhost:8080/videos/${videoId}/?api_key=0352af1a-7d25-4772-ad92-0e50126c17fc`
					: 'http://localhost:8080/videos/84e96018-4022-434e-80bf-000ce4cd12b8/?api_key=0352af1a-7d25-4772-ad92-0e50126c17fc'
			)
			.then((response) => {
		...
		<div className="App">
			...
			<div className="split">
				<div className="split-left">
					...
					<CommentForm />
					{mainVideo && mainVideo.comments && (
						<Comments comments={mainVideo.comments} />
					)}
				</div>
				<VideoList sideVideos={filteredVideoList} setMainVideo={setMainVideo} />
			</div>
		</div>
	);
}
